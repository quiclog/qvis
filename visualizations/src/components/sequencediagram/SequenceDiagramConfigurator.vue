    ...
    export default class SequenceDiagramConfigurator extends Vue {
        ...
        public get firstConnectionIsUnknownPerspective() {
            return  this.config.connections.length > 0 && 
                    this.config.connections[0].connection.getEvents().length > 0 &&
                    this.config.connections[0].connection.vantagePoint && 
                    this.config.connections[0].connection.vantagePoint.type === qlog.VantagePointType.unknown;
        }
