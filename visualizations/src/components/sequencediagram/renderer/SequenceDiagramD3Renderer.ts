...
export default class SequenceDiagramD3Renderer {
    ...
    protected ensureMoreThanOneTrace() {
        ...
        if ( (this.traces[0] as any).qvis && (this.traces[0] as any).qvis.sequencediagram.generatedSibling ) {
        ...
        this.createPrivateNamespace(this.traces[0]);
        (this.traces[0] as any).qvis.sequencediagram.generatedSibling = newTrace;
        this.createPrivateNamespace(newTrace);
        (newTrace as any).qvis.sequencediagram.generatedSibling = this.traces[0];
