...
import QlogConnection from './Connection';
import { type IQlogEventParser, type IQlogRawEvent, TimeTrackingMethod } from './QlogEventParser';
...
export class QlogLoaderV2 {
    ...
    protected static fromDraft02(json:any) : QlogConnectionGroup {
        ...
        for ( let jsonconnection of fileContents.traces ){
            ...
            if ( usesEventFields ){
                groupIDKey = (jsonconnection as any).event_fields.indexOf("group_id") as number;
