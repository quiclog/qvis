// export * from "@quictools/qlog-schema/draft-01/QLog";
// copied over from https://github.com/quiclog/qlog/blob/master/TypeScript/draft-01/QLog.ts
// instead of importing this very old repo here 
